...
bash scripts/run.sh DeepSeek-R1-Distill-Llama-70B-free 1000 verbal mmlu
bash scripts/run.sh DeepSeek-R1-Distill-Llama-70B-free 1000 verbal_cot mmlu
bash scripts/run.sh DeepSeek-R1-Distill-Llama-70B-free 100 verbal gpqa --debug
bash scripts/run.sh DeepSeek-R1-Distill-Llama-70B-free 100 verbal_cot gpqa --debug
